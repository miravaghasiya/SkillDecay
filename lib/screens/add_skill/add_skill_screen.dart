...
class _AddSkillScreenState extends State<AddSkillScreen> {
  ...
  DateTime _lastPracticed = DateTime.now();
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildDifficultyButton('Beginner'),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _buildDifficultyButton('Intermediate'),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _buildDifficultyButton('Advanced'),
                  ),
                ],
              ),
              const SizedBox(height: 24),
